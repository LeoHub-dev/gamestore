            ...
            <tbody>
              <tr>
                <td id="content" style="border-collapse: collapse; padding-right: 40px; padding-top: 20px; padding-bottom: 20px; padding-left: 40px;text-align: center;">
                  ...
                  <p class="heading" style="font-family: Helvetica, Arial, sans-serif; font-weight: 700; font-size: 16px; color: #59595b; margin-bottom: 20px; text-align: center;" align="center"><?= $title; ?></p>
                  <div class="cta margin-top-30px margin-bottom-50px" style="text-align: center; margin-top: 30px !important; margin-bottom: 50px !important;" align="center">
                    <!--[if mso]>
                        ...
                        fillcolor="#EF073F">
                          ...
                          <center>
                          <![endif]-->
                    <a href="<?= $link; ?>" style="color:#59595b;background-color:#EF073F;border-radius:25px;color:#ffffff;display:inline-block;font-family: 'Open Sans', Helvetica, Arial, sans-serif;font-size:14px;letter-spacing:1px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:300px;-webkit-text-size-adjust:none;"><?= $text_button; ?></a>
                    <!--[if mso]>
                          </center>
                        </v:roundrect>
                      <![endif]-->
